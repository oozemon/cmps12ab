...
* uzahid
* lab5
* The first error occured in what is now line 30 because the MAX_CODE was set to 5, and the in the intial code it was set to greater than or equal 5, instead of just equal to 5. Second
* error occured in line 70 because there was a misplaced semicolon which cause the program to run the error else statement instead of the assigned value of the word "stuff". The
* last error occured in the weatherModifier call, in which, again, there was a misplaced semicolon before the if statement that called foggy and was thus the reason it called the 
* word "foggy" instead of the intended "great".
*/
